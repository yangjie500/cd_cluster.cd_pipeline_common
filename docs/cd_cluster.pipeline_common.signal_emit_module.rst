.. _cd_cluster.pipeline_common.signal_emit_module:
...
**Emit a signal using a registered emitter**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Logical event type to emit.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>failure</td>
                <td>
                            <div>Error returned by the underlying emitter or transport.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">Server error: 503</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">Signal emitted</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>always</td>
                <td>
                            <div>Opaque emitter registration ID used.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">5e2d8f5b1de848ea7d45bcb4af0fb922</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Status code returned by the underlying transport, when available.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">204</div>
                </td>
            </tr>
    </table>
    <br/><br/>
